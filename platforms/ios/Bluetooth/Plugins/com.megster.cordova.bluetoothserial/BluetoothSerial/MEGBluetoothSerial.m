...
- (void)pluginInitialize {
    ...
    /*
    UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"tester 3" message:@"test" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
    [myAlert show];
     */
...
- (void)disconnect:(CDVInvokedUrlCommand*)command {
    ...
    UIAlertView *myAlert1 = [[UIAlertView alloc] initWithTitle:@"disconnect 1" message:@"" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
    [myAlert1 show];
    
    if (_bleShield.activePeripheral) {
        
        UIAlertView *myAlert2 = [[UIAlertView alloc] initWithTitle:@"disconnect 2" message:@"" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
        [myAlert2 show];
        
        if(_bleShield.activePeripheral.isConnected)
        {
            UIAlertView *myAlert3 = [[UIAlertView alloc] initWithTitle:@"disconnect 3" message:@"" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
            [myAlert3 show];
...
- (void)bleDidDisconnect {
    ...
    UIAlertView *myAlert1 = [[UIAlertView alloc] initWithTitle:@"disconnected" message:@"" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
    [myAlert1 show];
...
-(void)connectUuidTimer:(NSTimer *)timer {
   ...
   // UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"----- peripheral UUID ------" message:uuid delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
    //[myAlert show];
    ...
    if (peripheral) {
        ...
        //UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"peripheral exists" message:@"test" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
        //[myAlert show];
        
        [_bleShield connectPeripheral:peripheral];
    } else {
        
       // UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"peripheral does not exist" message:@"test" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
        //[myAlert show];
...
- (CBPeripheral*)findPeripheralByUUID:(NSString*)uuid {
    ...
    NSString *pCount = [NSString stringWithFormat:@"%d", peripherals.count];
    
    UIAlertView *myAlert3 = [[UIAlertView alloc] initWithTitle:@"peripherals count" message:pCount delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
    [myAlert3 show];
    ...
    for (CBPeripheral *p in peripherals) {
        ...
        NSString *uuidString = [NSString stringWithFormat:@"%@", [[p identifier] UUIDString]];
        
        UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"Device Name" message:p.name delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
        [myAlert show];
        
        UIAlertView *myAlert4 = [[UIAlertView alloc] initWithTitle:@"Device Identifier" message:uuidString delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
        [myAlert4 show];
        
        
        
        /*
        if ([p.UUID isEqual:[CBUUID UUIDWithString:@"F000AA00-0451-4000-B000-000000000000"]])  {
            
        }
         */
        
        /*
        UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"SERVICES?" message:@"?" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
        [myAlert show];
        ...
        for (CBService *s in p.services) {
            ...
            //3D29C2EB-423A-6A39-25CE-36AB29D90203
            
            UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"SERVICE FOUND" message:@"?" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
            [myAlert show];
            
            if ([s.UUID isEqual:[CBUUID UUIDWithString:@"F000AA00-0451-4000-B000-000000000000"]])  {
                
                // NSString *testUUIDString = [NSString stringWithFormat:@"%@",CFUUIDCreateString(nil, (__bridge CFUUIDRef)(s.UUID))];
                
                UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"SERVICE FOUND" message:@"F000AA00-0451-4000-B000-000000000000" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
                [myAlert show];
            }
        }
         */
        ...
        //TI BLE Sensor Tag
        if ([p.name isEqualToString:@"TI BLE Sensor Tag"]) {
            
            UIAlertView *myAlert2 = [[UIAlertView alloc] initWithTitle:@"Yep" message:@"Name is TI" delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles:nil, nil];
            [myAlert2 show];
